...
function run() {
    describe('DateTime', function () {
        ...
        describe('setValue', function () {
            ...
            it('should clear out existing value with blank value', function () {
                datetime.setValue('1994-12-15T13:47:20.789Z');
        ...
        var datetime;
        beforeEach(function () {
            datetime = new src_1.DateTime(new src_1.Form(), new src_1.Config(), null, {});
        });
