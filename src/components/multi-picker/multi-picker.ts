...
import { MultiPickerColumn, IMultiPickerOption, MultiPickerColumnDays, MultiPickerColumnMinutes } from './multi-picker-columns';
import { MultiPickerDateType, MultiPickerTimeType } from './multi-picker-types';
...
export class MultiPicker implements AfterContentInit, ControlValueAccessor, OnDestroy, OnInit {
  ...
  _value: any;
  id: string;
  private multiPickerColumns: MultiPickerDateType | MultiPickerTimeType;
...
//     if (this.type == 'date') {
//       this.multiPickerColumns = new MultiPickerDateType({
//         customFilterDays: this.customFilterDays,
//         weekends: this.weekends
//       })
//     } else {
//       this.multiPickerColumns = new MultiPickerTimeType({
//         min: this.min,
//         max: this.max
//       })
//     }
